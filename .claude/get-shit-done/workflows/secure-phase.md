...
```
Agent(
  prompt="Read /home/user/flow/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/flow/.claude/get-shit-done/templates/SECURITY.md`
