...
```markdown
Read /home/user/flow/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/flow/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/flow/.claude/agents/gsd-ui-checker.md for instructions.
