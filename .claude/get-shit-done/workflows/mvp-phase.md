...
<required_reading>
@/home/user/flow/.claude/get-shit-done/references/user-story-template.md
@/home/user/flow/.claude/get-shit-done/references/spidr-splitting.md
@/home/user/flow/.claude/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/home/user/flow/.claude/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/home/user/flow/.claude/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/home/user/flow/.claude/get-shit-done/references/spidr-splitting.md`. Briefly:
