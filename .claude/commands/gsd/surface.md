...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/flow/.claude/.gsd-surface.json`
(sibling to `/home/user/flow/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/flow/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/flow/.claude/skills`).
...
`/home/user/flow/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/flow/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/flow/.claude/.gsd-surface.json`
Install profile marker: `/home/user/flow/.claude/.gsd-profile`
Skill dirs: `/home/user/flow/.claude/skills/gsd-*/`
Engine module: `/home/user/flow/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/home/user/flow/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
