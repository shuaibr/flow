...
- @/home/user/flow/.claude/get-shit-done/workflows/complete-milestone.md (main workflow)
- @/home/user/flow/.claude/get-shit-done/templates/milestone-archive.md (archive template)
  </execution_context>
