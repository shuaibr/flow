...
<reference>
@/home/user/flow/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/flow/.claude/get-shit-done/references/user-profiling.md` to load:
