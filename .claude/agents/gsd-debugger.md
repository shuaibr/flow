...
<required_reading>
@/home/user/flow/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/home/user/flow/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/flow/.claude
                  → checks /home/user/flow/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/flow/.claude/get-shit-done
                  → writes to /home/user/flow/.claude/get-shit-done/hooks/
...
@/home/user/flow/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/user/flow/.claude/get-shit-done/references/common-bug-patterns.md
