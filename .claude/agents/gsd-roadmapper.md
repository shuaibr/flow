...
Reference full template: `/home/user/flow/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/flow/.claude/get-shit-done/templates/state.md`.
