<!-- Canonical copy lives at the workspace root, above all six repos; this in-repo copy exists because SPEC.md reads alongside it. Sync from workspace root when it changes. -->
